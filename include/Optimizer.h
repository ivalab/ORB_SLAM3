...
public:
    ...
    void static LocalBundleAdjustmentWithPrior(KeyFrame* pKF, bool *pbStopFlag, Map *pMap, int& num_fixedKF, int& num_OptKF, int& num_MPs, int& num_edges);

    int static PoseOptimization(Frame* pFrame);
    int static PoseOptimizationWithRelativeConstraint(Frame* pFrame, Frame* pLastFrame);
